...
const socket = new WebSocket('ws://10.0.7.199:5000');
...
let lastReadTime = 0;
const readInterval = 1000; // Tempo em milissegundos entre as leituras
...
function handleNotifications(event) {
    ...
    if (currentTime - lastReadTime >= readInterval) {
        // Realize a leitura dos dados recebidos aqui
        let value = event.target.value;
        // Faça o processamento necessário com os dados
        
        // Atualize o horário da última leitura
