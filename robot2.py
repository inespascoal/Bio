...
def forward():
    ...
    for i in range(270):
        ...
        if i > 90 and i < 110:
            servo.setServoAngle(2, 60 - (i-90)) # final 40
            servo.setServoAngle(10, 120 + (i-90)) # final 140
        
        if i > 180:
            servo.setServoAngle(2, 40 - (i-90)/9)    # final 20
            servo.setServoAngle(10, 140 + (i-90)/7.2) # final 165
